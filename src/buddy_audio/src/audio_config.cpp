...
void declare_audio_parameters(rclcpp_lifecycle::LifecycleNode& node) {
    ...
    node.declare_parameter("preprocess.webrtc.enable", false);
    node.declare_parameter("preprocess.webrtc.vad.enable", false);
    node.declare_parameter("preprocess.webrtc.vad.gate.enable", false);
    ...
    node.declare_parameter("preprocess.webrtc.vad.min_voice_frames", 1);
    node.declare_parameter("preprocess.webrtc.vad.hangover_frames", 12);
    node.declare_parameter("preprocess.webrtc.ns.enable", false);
    node.declare_parameter("preprocess.webrtc.ns.level", 2);
    node.declare_parameter("preprocess.webrtc.agc.enable", false);
    node.declare_parameter("preprocess.webrtc.agc.mode", 2);
    node.declare_parameter("preprocess.webrtc.agc.target_level_dbfs", 3);
    node.declare_parameter("preprocess.webrtc.agc.compression_gain_db", 9);
    ...
    node.declare_parameter("preprocess.webrtc.aec.enable", false);
    node.declare_parameter("preprocess.webrtc.aec.suppression_level", 1);
    node.declare_parameter("preprocess.webrtc.aec.stream_delay_ms", 60);
    node.declare_parameter("kws.enable", true);
    ...
    node.declare_parameter("kws.threshold", 0.1f);
    node.declare_parameter("kws.score", 3.0f);
    node.declare_parameter("asr.mode", "local");
    node.declare_parameter("asr.engine", "auto");
    node.declare_parameter("asr.runtime", "auto");
    ...
    node.declare_parameter("tts.engine", "auto");
    node.declare_parameter("tts.runtime", "auto");
    node.declare_parameter("tts.server.chattts.url", "http://127.0.0.1:9880/tts");
    node.declare_parameter("tts.local.sherpa.model_type", "kokoro");
    ...
    node.declare_parameter("asr_cooldown_ms", 500);
