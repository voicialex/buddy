...
TEST_F(DialogNodeTest, NodeName) { EXPECT_EQ(node_->get_name(), std::string("dialog")); }
TEST_F(DialogNodeTest, ConfigureTransition) { EXPECT_STREQ(node_->configure().label().c_str(), "inactive"); }
