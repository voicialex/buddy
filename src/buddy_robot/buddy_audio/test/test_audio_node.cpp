...
TEST_F(AudioNodeTest, NodeName) { EXPECT_EQ(node_->get_name(), std::string("audio")); }
TEST_F(AudioNodeTest, ConfigureTransition) { EXPECT_STREQ(node_->configure().label().c_str(), "inactive"); }
