...
TEST_F(StateMachineNodeTest, NodeName) { EXPECT_EQ(node_->get_name(), std::string("state_machine")); }
TEST_F(StateMachineNodeTest, ConfigureTransition) { EXPECT_STREQ(node_->configure().label().c_str(), "inactive"); }
